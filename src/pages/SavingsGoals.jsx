...
// 🎨 MOTO CARD COLORS (UPDATED TO UNIFORM TRANSLUCENT GREEN THEME)
const MOTO_CARD_COLORS = [
  {
    bg: 'bg-emerald-500/10 border-emerald-500/40 dark:bg-emerald-950/20 backdrop-blur-md',
...
export default function SavingsGoals() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-6">
      ...
      {/* 🏍️ GREEN TRANSLUCENT MOTORCYCLES PERFORMANCE MATRIX */}
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="text-xs font-black uppercase tracking-wider text-ink flex items-center gap-2">
            <Bike size={16} className="text-emerald-600 dark:text-emerald-400" /> Motorcycles Net Performance ({motorcycles.length})
          </h2>
        </div>

        {/* TRANSLUCENT GREEN COMPACT CARDS GRID */}
